...
namespace JsonApiSerializer.Util
{
    internal static class ReaderUtil
    {
        ...
        //                else if (propName == PropertyNames.Tid)
        //                {
        //                    if (lookAheadReader.TokenType != JsonToken.String)
        //                        throw new JsonApiFormatException(lookAheadReader.FullPath,
        //                            $"Expected to find string at {lookAheadReader.FullPath}",
        //                            "The value of 'tid' MUST be a string");
        //                    reference.Tid = (string)lookAheadReader.Value;
        //                }
        ...
        //                if ((reference.Id != null || reference.Tid != null) && reference.Type != null)
        //                    break;
        //            }
        ...
        public static string ReadUntilStart(JsonReader reader, Regex pathRegex)
        {
                ...
                switch (reader.TokenType)
                {
                    ...
                    case JsonToken.EndArray:
                        if (reader.Path == startPath)
                            throw new JsonException($"Expected to find nested object within {startPath} that matches \\{pathRegex}\\");
                        break;
                    default:
                        break;
            ...
            throw new JsonException( $"Expected to find nested object matching path \\{pathRegex}\\");
        }
        ...
        public static void ReadUntilEnd(JsonReader reader, string path)
        {
            ...
            throw new JsonException( $"Unable to find closing element for item at path '{path}'");
        }
    }
}
